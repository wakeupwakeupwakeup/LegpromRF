...
const Home = () => {
  ...
  return ( 
    ...
    <div className="wrapper">
                  ...
                  <nav className={styles.header__nav}>
                    <ul className={styles.header__list}>
                      <li className={styles.header__item}>
                        <Link href="/" className={styles.header__link}>Новости платформы</Link>
                      </li>
                      <li className={styles.header__item}>
                        <Link href="/" className={styles.header__link}>Тарифы</Link>
                      </li>
                    </ul>
                  </nav>
              </div>
      ...
      <main className="page">
        <section className={styles.landin}>
            <div className="landing__container">
              ...
              <div className={styles.landing__left}>
                <div className={styles.landing__content}>
                  ...
                  <div className={styles.landing__auth}>Зарегистрироваться бесплатно</div>
                  <div className={styles.landing__guest}>Войти как гость</div>
                  ...
                  <div className={styles.card__item}>
                    <div className={styles.card__body}>
                      <Image 
                        ...
                        height={228}
                      />
                      <h4 className={styles.card__title}>Пошив платья для официантов</h4>
                      <p className={styles.card__number}>№24500968</p>
                      <div className={styles.card__info}>
                          <div className={styles.card__infoItem}>
                            <div className={styles.card__label}>Тираж</div>
                            <div className={styles.card__description}>250 шт.</div>
                          </div>
                          <div className={styles.card__infoItem}>
                            <div className={styles.card__label}>Опубликовано</div>
                            <div className={styles.card__description}>25.03.2023</div>
                          </div>
                          <div className={styles.card__infoItem}>
                            <div className={styles.card__label}>Бюджет</div>
                            <div className={styles.card__description}>500 000 ₽</div>
                          </div>
                          <div className={styles.card__infoItem}>
                            <div className={styles.card__label}>Сдача</div>
                            <div className={styles.card__description}>25.06.2023</div>
                          </div>
                      </div>
