      ...
      <div className={styles.selection}>
        ...
        <div className={styles.selection__content}>
            ...
            <div className={styles.selection__control}>
              ...
              {
                choice ? 
                  <div className={styles.selection__respond}><Link href="/">Отправить выбранным</Link></div>
                :
                  <div className={styles.selection__respond_orange}><Link href="/">Отправить заявку всем</Link></div>  
              }
